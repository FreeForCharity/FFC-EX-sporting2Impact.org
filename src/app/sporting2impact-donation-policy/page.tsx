      ...
      <div className="py-[21px] w-[90%] md:w-[80%] mx-auto max-w-[1080px]">
        <div id="aria-font">
          <h1 className="text-[30px] text-[#333] pb-[10px] leading-[30px] font-[500]">
            Sporting2Impact Donation Policy
          </h1>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Sporting2Impact, a US 501(c)(3) non-profit organization, is dedicated to improving our
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Sporting2Impact accepts a wide range of donations, subject to the following criteria:
          </p>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            For donations of real estate, securities, and personal property, Sporting2Impact will
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Sporting2Impact is committed to recognizing and appreciating the generosity of our
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            With the donor’s consent, Sporting2Impact will recognize significant contributions
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Sporting2Impact is committed to maintaining the highest ethical standards. All
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Sporting2Impact deeply values the support of our donors and is committed to ensuring
