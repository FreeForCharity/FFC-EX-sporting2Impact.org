    ...
    <div className="pt-[130px] pb-[54px]">
      <div className="py-[27px] w-[90%] md:w-[80%] mx-auto">
        <div id="aria-font">
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Welcome to Sporting2Impact INC! These Terms of Service (“Terms”) govern your access to
            and use of our website, services, and platforms (collectively, “Services”), provided by
            Sporting2Impact INC (“we,” “us,” or “our”). By accessing or using our Services, you
          ...
          <ul className="list-inside ml-[1.5em] space-y-[4px]">
            ...
            <li className="text-[14px] text-[#666] leading-[24px] font-[500]">
              Using the Services to solicit funds outside the scope of Sporting2Impact’s mission.
            </li>
          </ul>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            All donations made to Sporting2Impact are voluntary and non-refundable. By making a
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            All payments made to Sporting2Impact are voluntary and non-refundable. No refunds will
            be given due to the nonprofit nature of Sporting2Impact.
          </p>
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            are the property of Sporting2Impact or its licensors. You agree not to use, reproduce,
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Our Services are provided on an “as is” and “as available” basis. Sporting2Impact makes
            no representations or warranties of any kind, express or implied, regarding the use or
            the results of our Services in terms of accuracy, reliability, or otherwise.
            Sporting2Impact disclaims all warranties, express or implied, including, but not limited
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            To the fullest extent permitted by law, Sporting2Impact shall not be liable for any
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            You agree to indemnify, defend, and hold harmless Sporting2Impact, its officers,
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            Thank you for supporting Sporting2Impact and for complying with these Terms of Service.
          </p>
        </div>
      </div>
    </div>
