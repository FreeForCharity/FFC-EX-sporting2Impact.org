...
describe('assetPath utility', () => {
  ...
  it('should prepend basePath when NEXT_PUBLIC_BASE_PATH is set', () => {
    process.env.NEXT_PUBLIC_BASE_PATH = '/FFC-EX-sporting2Impact.org'
    expect(assetPath('/logo.png')).toBe('/FFC-EX-sporting2Impact.org/logo.png')
  })

  it('should handle paths with subdirectories', () => {
    process.env.NEXT_PUBLIC_BASE_PATH = '/FFC-EX-sporting2Impact.org'
    expect(assetPath('/images/hero.jpg')).toBe('/FFC-EX-sporting2Impact.org/images/hero.jpg')
  })

  it('should handle root path', () => {
    process.env.NEXT_PUBLIC_BASE_PATH = '/FFC-EX-sporting2Impact.org'
    expect(assetPath('/')).toBe('/FFC-EX-sporting2Impact.org/')
  })
})
