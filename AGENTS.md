# AI Agent Instructions: FFC-EX-sporting2Impact.org
...
These sites deploy to `https://freeforcharity.github.io/FFC-EX-sporting2Impact.org/` and optionally to a custom domain if one is configured for this repo.
