...
| ----------------- | --------------------- | ------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| Header Navigation | Logo Image            | `https://sporting2impact.org/wp-content/uploads/2024/04/Screenshot_145.png` (Sporting2Impact horizontal logo) | _(URL or file path to your charity's horizontal logo, recommended size: 150px wide × 44px tall for best display)_ |
...
| Volunteer | Volunteer Button Link    | "https://www.idealist.org/en/nonprofit/356bfc8e2ae64f83beea4a4e677e99d7-sporting2impact-state-college#opportunities"                                                                                     | _(Link to your volunteer sign-up page)_                                      |
...
| Donate  | Supporting Image          | `/Images/support-sporting2impact.webp`                                                                                        | _(Image file, recommended size: 578px × 386px)_                                   |
| Donate  | Supporting Image Alt Text | "support Sporting2Impact image"                                                                                               | _(Description of image)_                                                          |
| Donate  | Donation Form URL         | "https://www.zeffy.com/embed/donation-form/sporting2impact-endowment-fund"                                                    | _(Your donation form embed URL - from Zeffy, PayPal, or other donation platform)_ |
...
| Programs | Program 1 - Description           | "Provides free .org domain names, Microsoft 365 with Outlook email, & Microsoft Teams to 501(c)(3) charities." | _(Brief description of what this program does)_              |
...
| --- | ---------------------- | -------------------------------- | ------------------------------------------------- | ------------------------------------------------------- | ------------------------------------------------- | --------- | ---------- | ------------- |
| 1   | `/Images/member1.webp` | "Siva Rama Krishna Chagarlamudi" | "Sporting2Impact Founder/ President of the Board" | "https://www.linkedin.com/in/clarkemoyer/"              | _(Photo file, recommended: 400px × 400px square)_ |           |            |               |
...
| Footer  | Quick Link 9 - URL  | "https://sporting2impact.org/hub/" |                                    |
...
| Footer  | Policy Link 1 - URL    | "/sporting2impact-donation-policy"                | "/donation-policy"                   |
...
| Footer  | GitHub URL            | "https://github.com/FreeForCharity/FFC-EX-sporting2Impact.org" | _(Your GitHub organization URL, or leave blank)_     |
...
| Section | Variable          | Current Sporting2Impact Content                                                 | Your Content                                         |
| ------- | ----------------- | ------------------------------------------------------------------------------- | ---------------------------------------------------- |
| Footer  | Copyright Text    | "© {year} All Rights Are Reserved by Sporting2Impact a US 501(c)(3) Non Profit" | _(Replace "Sporting2Impact" with your charity name)_ |
| Footer  | Project Link Text | "A project of"                                                                  | _(Optional - if part of a larger organization)_      |
| Footer  | Project Link URL  | "https://sporting2impact.org"                                                   |                                                      |
...
- **Donate section**: Edit `src/components/home-page/support-sporting2impact/index.tsx`
...
- **Team section**: Edit `src/components/home-page/the-sporting2impact-team/index.tsx`
