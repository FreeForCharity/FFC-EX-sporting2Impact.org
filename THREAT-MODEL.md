...
This document outlines the security threat model for the Sporting2Impact website, identifying potential security risks, trust boundaries, and mitigation strategies for our technology stack.

## Overview

The Sporting2Impact website is a static Next.js application deployed to GitHub Pages. As a nonprofit organization, we prioritize protecting our reputation, maintaining service availability, and ensuring the security of our community.
...
2. **Hosting and Deployment**
   ...
   - Custom domain: sporting2impact.org
