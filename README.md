...
**Primary Contact**: Siva Rama Krishna Chagarlamudi ([@clarkemoyer](https://github.com/clarkemoyer)) - info@sporting2impact.org
...
- Sporting2Impact Donation Policy (`/sporting2impact-donation-policy`)
...
3. **Configure Build Settings**
   ...
   - Environment variables: Leave `NEXT_PUBLIC_BASE_PATH` unset
     - GitHub Pages needs `/FFC-EX-sporting2Impact.org` for subdirectory routing
...
- GitHub Pages URL: [https://freeforcharity.github.io/FFC-EX-sporting2Impact.org/](https://freeforcharity.github.io/FFC-EX-sporting2Impact.org/)
