...
- **GitHub Pages URL**: https://github.com/FreeForCharity/FFC-EX-sporting2Impact.org
...
1. **GitHub Pages subpath deployment**: `/FFC-EX-SPORTING2IMPACT.ORG/`
...
2. **Configure DNS records** at your domain provider:
   - **Type**: CNAME
   - **Name**: www (or @)
   - **Value**: sporting2impact.github.io
...
# Open http://localhost:3000/FFC-EX-sporting2Impact.org in your browser
```
...
**Questions?** Open an issue or contact the maintainers at hello@sporting2impact.org
